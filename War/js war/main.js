...
var timer;
var r = 0;
var battleButton = document.querySelector("#btnBattle");
var battleButton10 = document.querySelector("#btnBattle10");
var battleButton50 = document.querySelector("#btnBattle50");
...
battleButton10.addEventListener("click", function(){
    rounds(10);
});
battleButton50.addEventListener("click", function(){
    rounds(50);
});
//functions
function rounds(a){
...
function showCard(c, p){
    ...
    bCard += '<div class="cardtop suit">' +c.num+ '<br><br></div>';
    bCard += '<div class="cardmid suit"></div>'
    bCard += '<div class="cardbottom suit">' +c.num+ '<br><br></div></div>';
    return bCard;
}
